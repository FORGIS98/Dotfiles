...
-- import qualified XMonad.Util.Brightness as Bright -- Not in use, I use brillo
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch rofi
    , ((modm,               xK_d     ), spawn "rofi -show run -config ~/.config/rofi/config.rasi")

    -- launch gmrun -- xK_p en uso en otro lugar!
    ...
    , ((modm,               xK_ntilde     ), windows W.focusUp  )
    -- Move focus to the previous window
    ...
    , ((modm .|. shiftMask, xK_ntilde     ), windows W.swapUp    )
    -- Swap the focused window with the previous window
